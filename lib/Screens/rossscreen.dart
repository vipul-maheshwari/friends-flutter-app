...
import 'package:friendsapp/Characters/ross.dart';
...
class Rossscreen extends StatefulWidget {
  const Rossscreen({Key? key}) : super(key: key);

  @override
  _RossscreenState createState() => _RossscreenState();
}

class _RossscreenState extends State<Rossscreen> {
  int Sexcount = 0;

  List<Rosshobbies> hobbies = [
    Rosshobbies(hobbyname: 'Getting Divorces'),
    Rosshobbies(hobbyname: 'Being sad all the time'),
  ];

  List<Rossskills> skills = [
    Rossskills(skillname: 'Getting on dates'),
    Rossskills(skillname: 'His perseverance'),
  ];

  List<Rosslove> loves = [
    Rosslove(lovename: 'Rachel'),
    Rosslove(lovename: 'His son with Carol'),
  ];
