...
import 'package:friendsapp/Characters/Joey.dart';
...
class Joeyscreen extends StatefulWidget {
  const Joeyscreen({Key? key}) : super(key: key);

  @override
  _JoeyscreenState createState() => _JoeyscreenState();
}

class _JoeyscreenState extends State<Joeyscreen> {
  int Sexcount = 0;

  List<Joeyhobbies> hobbies = [
    Joeyhobbies(hobbyname: 'Watching porn'),
    Joeyhobbies(hobbyname: 'Seeing Baywatch'),
    Joeyhobbies(hobbyname: 'Playing Fossball'),
  ];

  List<Joeyskills> skills = [
    Joeyskills(skillname: 'Not have any'),
    Joeyskills(skillname: 'One Night stand'),
  ];

  List<Joeylove> loves = [
    Joeylove(lovename: 'Sex'),
    Joeylove(lovename: 'Food'),
  ];
