...
import 'package:friendsapp/Characters/chandler.dart';
...
class Chandlerscreen extends StatefulWidget {
  const Chandlerscreen({Key? key}) : super(key: key);

  @override
  _ChandlerscreenState createState() => _ChandlerscreenState();
}

class _ChandlerscreenState extends State<Chandlerscreen> {
  int Sexcount = 0;

  List<Chandlerhobbies> hobbies = [
    Chandlerhobbies(hobbyname: 'Watching porn'),
    Chandlerhobbies(hobbyname: 'Seeing Baywatch'),
    Chandlerhobbies(hobbyname: 'Playing Fossball'),
  ];

  List<Chandlerskills> skills = [
    Chandlerskills(skillname: 'Cracking Bad Jokes'),
    Chandlerskills(skillname: 'Pay the rent for Joey'),
  ];

  List<Chandlerlove> loves = [
    Chandlerlove(lovename: 'Sex with Monica'),
    Chandlerlove(lovename: 'Sleeping late'),
  ];
