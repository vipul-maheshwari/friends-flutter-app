...
import 'package:friendsapp/Characters/Rachel.dart';
...
class Rachelscreen extends StatefulWidget {
  const Rachelscreen({Key? key}) : super(key: key);

  @override
  _RachelscreenState createState() => _RachelscreenState();
}

class _RachelscreenState extends State<Rachelscreen> {
  int Sexcount = 0;

  List<Rachelhobbies> hobbies = [
    Rachelhobbies(hobbyname: 'Shopping'),
    Rachelhobbies(hobbyname: 'Writing 18 pages letter'),
    Rachelhobbies(hobbyname: 'Catching Ross'),
  ];

  List<Rachelskills> skills = [
    Rachelskills(skillname: 'Cook the food witout gas'),
    Rachelskills(skillname: 'Courageous'),
  ];

  List<Rachellove> loves = [
    Rachellove(lovename: 'Being Ross\'s lobster'),
    Rachellove(lovename: 'Bloomingdale\'s sale'),
  ];
